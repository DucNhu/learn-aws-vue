...
export declare class BlogModel {
  ...
  static copyOf(
    source: BlogModel,
    mutator: (
      draft: MutableModel<BlogModel, BlogModelMetaData>
    ) => MutableModel<BlogModel, BlogModelMetaData> | void
  ): BlogModel;
}
...
export declare class CommentModel {
  ...
  static copyOf(
    source: CommentModel,
    mutator: (
      draft: MutableModel<CommentModel, CommentModelMetaData>
    ) => MutableModel<CommentModel, CommentModelMetaData> | void
  ): CommentModel;
}
...
export declare class ReplyCommentModel {
  ...
  static copyOf(
    source: ReplyCommentModel,
    mutator: (
      draft: MutableModel<ReplyCommentModel, ReplyCommentModelMetaData>
    ) => MutableModel<ReplyCommentModel, ReplyCommentModelMetaData> | void
  ): ReplyCommentModel;
}
...
export declare class ReplyCommentModel {
  ...
  static copyOf(
    source: LikeModel,
    mutator: (
      draft: MutableModel<LikeModel, LikeModelMetaData>
    ) => MutableModel<LikeModel, LikeModelMetaData> | void
  ): LikeModel;
}
...
export declare class UntitledFkModel {
  ...
  static copyOf(
    source: UntitledFkModel,
    mutator: (
      draft: MutableModel<UntitledFkModel, UntitledFkModelMetaData>
    ) => MutableModel<UntitledFkModel, UntitledFkModelMetaData> | void
  ): UntitledFkModel;
}
